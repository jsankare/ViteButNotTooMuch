export default function About() {
  return (
    <div className="max-w-2xl mx-auto">
      <h1>About ViteButNotTooMuch</h1>
      
      <section className="mb-8">
        <h2>Our Philosophy</h2>
        <p>
          Small daily actions lead to real progress. We believe in the power of 
      ...
      <section className="mb-8">
        ...
        <p>
          Categories span across mind, wellness, and learning - because holistic 
          growth comes from diverse experiences.
        </p>
      </section>

      <section>
        <h2>Why Micro-Challenges?</h2>
        <p>
          Big goals can be overwhelming. Breaking them down into small, daily 
          actions makes progress manageable and sustainable.
        </p>
        <p>
